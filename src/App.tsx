              ...
              >
                ...
                <div className="max-w-4xl mx-auto space-y-[25vh] px-4 sm:px-8 pt-[10vh]">
                  ...
                  <motion.div {...fadeAnimProps} className="text-center max-w-3xl mx-auto flex flex-col items-center">
                    ...
                    <p className="text-lg leading-relaxed opacity-80 text-center">
                      Use this suite to fine-tune your wet lab parameters, such as incubation temperature, precursor concentrations, and inoculation volumes. The simulated outputs guide exact experimental setups, ensuring you achieve the optimal shear modulus and environmental durability in your physical implementation.
                    </p>
                  </motion.div>
