...
export function buildCoreNetwork(opts?: {
  ...
  const r = (
    id: string,
    name: string,
    subsystem: CoreReactionMeta["subsystem"],
  ...
  const reactions: CoreReactionMeta[] = [
    ...
    r(
      "GLY",
      "Glycolysis (G6P→2 PEP)",
      "glycolysis",
      { G6P: -1, PEP: 2, ATP: 2, NADH: 2 },
      0,
      1000,
      "pfkA",
    ),
    ...
    r(
      "ZWF",
      "Pentose-P pathway (oxidative)",
      "ppp",
      { G6P: -1, R5P: 1, co2: 1, NADPH: 2 },
      0,
      1000,
      "zwf",
    ),
    ...
    r(
      "AKGD",
      "2-oxoglutarate DH → OAA (cycle closure)",
      "tca",
      { AKG: -1, OAA: 1, NADH: 3, co2: 1, ATP: 1 },
      0,
      1000,
      "odhAB",
    ),
    ...
    r(
      "GOGAT",
      "GS–GOGAT glutamate synthesis",
      "pga",
      { AKG: -1, nh3: -1, NADPH: -1, ATP: -1, GLU: 1 },
      0,
      1000,
      "glnA/gltAB",
    ),
    ...
    r(
      "LDH",
      "Lactate overflow (fermentative NADH sink)",
      "overflow",
      { PYR: -1, NADH: -1, lac: 1 },
      0,
      1000,
    ...
    r(
      "THD",
      "Transhydrogenase (NADPH→NADH balance)",
      "energy",
      { NADPH: -1, NADH: 1 },
      0,
      1000,
