 ...
 */
export function moistureRetention(appliedPercent: number, relativeHumidity: number, temperatureC: number): number {
...
export function modulusAfterWashout(baseModulus: number, cycles: number): number {
