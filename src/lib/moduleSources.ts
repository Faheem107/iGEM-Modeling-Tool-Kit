...
export const MODULE_SOURCES: Record<ModuleId, ModuleSources> = {
  fba: {
    ...
    sources: [
      { label: 'Orth, Thiele & Palsson (2010), "What is flux balance analysis?", Nat. Biotechnol. 28:245', detail: 'The canonical statement of the FBA linear program (max cᵀv s.t. S·v = 0) this module solves.', kind: 'model', url: 'https://doi.org/10.1038/nbt.1614' },
  ...
  thermal: {
    ...
    sources: [
      ...
      { label: 'Protein two-state stability curve ΔG(T)', detail: 'The thermodynamic form the folded-fraction gate is built on.', kind: 'literature' },
    ],
  },
  'protein-3d': {
    intro: 'A structural view of the key enzymes — PgsBCA (γ-PGA synthase, Prong 1) and carbonic anhydrase (Prong 2).',
    sources: [
      { label: 'RCSB Protein Data Bank — deposited structures (uploaded .pdb)', detail: 'The Cα backbone is drawn directly from residue coordinates; no free parameters.', kind: 'literature', url: 'https://www.rcsb.org/' },
      { label: 'Carbonic anhydrase II (PDB 1CA2) as the Prong-2 catalytic reference', detail: 'Representative fold for the displayed CA enzyme.', kind: 'literature', url: 'https://www.rcsb.org/structure/1CA2' },
    ],
  },
  ecological: {
  ...
  aeolian: {
    ...
    sources: [
      ...
      { label: 'Cohesion-enhanced threshold: adhesive term γ/(ρₐd)', detail: 'How crust cohesion enters the Bagnold threshold; UAE design winds 16–20 m/s.', kind: 'internal' },
    ],
  },
  wetlab: {
  ...
  grainsize: {
    ...
    sources: [
      { label: 'Erdmann et al. (2024), Discover Materials — MICP vs particle size', detail: 'MICP UCS-vs-diameter sweet spot (~63–125 µm) and the coarse/fine fall-off (GRAINSIZE_CALIB).', kind: 'literature', url: 'https://doi.org/10.1007/s43939-024-00108-3' },
      { label: 'UAE dune-sand grain-size distribution (D₅₀ ≈ 200 µm, well-sorted)', detail: 'The log-normal PSD coverage is integrated over.', kind: 'internal' },
    ],
  },
  composite: {
  ...
  curing: {
    ...
    sources: [
      { label: 'NYUAD field spray protocol (0/8/16/24/32 h; re-apply ~6 months)', detail: 'Maturation window and re-application interval (CURING_CALIB).', kind: 'internal' },
      { label: 'Optimised calcite crust survives ~30 m/s', detail: 'The design-wind survival floor the weathering timeline is checked against.', kind: 'internal' },
  ...
  economic: {
    intro: 'Bottom-up per-prong deployment cost, summed per combination and benchmarked against the published biocementation and carbon-market literature — every headline figure below is checked against a real study.',
    sources: [
      { label: '"Strategies for cost-optimized biocement production" (2025), World J. Microbiol. Biotechnol. 41', detail: 'Reagent/feedstock cost drivers (calcium source, cultivation, application) behind the Prong-2 MICP cost base (ECONOMIC_CALIB).', kind: 'literature', url: 'https://doi.org/10.1007/s11274-025-04281-2' },
      { label: 'Plant-derived urease EICP field study (2025), PLOS One — doi:10.1371/journal.pone.0331241', detail: 'Carbonate-precipitation treatment at ≈ $52 m⁻³ vs ≈ $135 m⁻³ for microbial MICP — the order-of-magnitude reality check on caReagentCostPerHa.', kind: 'literature', url: 'https://doi.org/10.1371/journal.pone.0331241' },
      { label: 'Sodium-alginate market price — bulk ≈ $6–12 kg⁻¹ (IMARC / Procurement Resource price trend, 2024)', detail: 'Grounds alginateCostPerKg = 9 USD·kg⁻¹ (Prong-3 commodity binder).', kind: 'literature', url: 'https://www.imarcgroup.com/sodium-alginate-price-trend' },
      { label: 'State of the Voluntary Carbon Market 2024 — average ≈ $6 tCO₂⁻¹; nature-based removals command a premium', detail: 'Sets the CO₂ credit subtracted from the CaCO₃ prong (co2CreditPerKg corrected from $50 to $10 tCO₂⁻¹).', kind: 'literature', url: 'https://carboncredits.com/carbon-prices-today/' },
      { label: 'Conventional baselines — USDA Forest Service, "Dust Palliative Selection and Application Guide" (9977-1207); commercial polymer emulsions (Soilworks Soiltac)', detail: 'The petrochemical dust-suppressant and hard-engineering costs the biological treatment breaks even against.', kind: 'literature', url: 'https://www.fs.usda.gov/t-d/pubs/pdf/99771207.pdf' },
    ],
  },
};
